...
export function gregorianToJalali(g_y, g_m, g_d, str_d) {
  const g_days_in_month = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
  const j_days_in_month = [31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 29];
  ...
  var j_np = parseInt(j_day_no / 12053); /* 12053 = 365*33 + 32/4 */
  j_day_no = j_day_no % 12053;

  var jy =
    979 + 33 * j_np + 4 * parseInt(j_day_no / 1461); /* 1461 = 365*4 + 4/4 */
